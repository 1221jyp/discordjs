...
//   { market: "BTC-ETC", korean_name: "이더리움클래식", english_name: "Ethereum Classic" },
...
//   { market: "BTC-BAT", korean_name: "베이직어텐션토큰", english_name: "Basic Attention Token" },
...
//   { market: "USDT-ETC", korean_name: "이더리움클래식", english_name: "Ethereum Classic" },
...
//   { market: "BTC-MANA", korean_name: "디센트럴랜드", english_name: "Decentraland" },
...
//   { market: "BTC-BCH", korean_name: "비트코인캐시", english_name: "Bitcoin Cash" },
//   { market: "USDT-BCH", korean_name: "비트코인캐시", english_name: "Bitcoin Cash" },
//   { market: "KRW-BCH", korean_name: "비트코인캐시", english_name: "Bitcoin Cash" },
//   { market: "BTC-HIFI", korean_name: "하이파이", english_name: "Hifi Finance" },
//   { market: "BTC-LOOM", korean_name: "룸네트워크", english_name: "Loom Network" },
...
//   { market: "BTC-UPP", korean_name: "센티넬프로토콜", english_name: "Sentinel Protocol" },
...
//   { market: "USDT-ZRX", korean_name: "제로엑스", english_name: "0x Protocol" },
//   { market: "USDT-RVN", korean_name: "레이븐코인", english_name: "Ravencoin" },
//   { market: "USDT-BAT", korean_name: "베이직어텐션토큰", english_name: "Basic Attention Token" },
...
//   { market: "BTC-BSV", korean_name: "비트코인에스브이", english_name: "Bitcoin SV" },
...
//   { market: "BTC-STPT", korean_name: "에스티피", english_name: "Standard Tokenization Protocol" },
...
//   { market: "BTC-OGN", korean_name: "오리진프로토콜", english_name: "Origin Protocol" },
...
//   { market: "BTC-RSR", korean_name: "리저브라이트", english_name: "Reserve Rights" },
...
//   { market: "BTC-AQT", korean_name: "알파쿼크", english_name: "Alpha Quark Token" },
//   { market: "BTC-AXS", korean_name: "엑시인피니티", english_name: "Axie Infinity" },
...
//   },
//   { market: "BTC-JUV", korean_name: "유벤투스", english_name: "Juventus Fan Token" },
...
//   { market: "BTC-HPO", korean_name: "히포크랏", english_name: "Hippocrat" },
...
//   { market: "BTC-NEAR", korean_name: "니어프로토콜", english_name: "NEAR Protocol" },
...
//   { market: "BTC-GRT", korean_name: "더그래프", english_name: "The Graph" },
...
//   { market: "BTC-1INCH", korean_name: "1인치네트워크", english_name: "1inch Network" },
//   { market: "BTC-MASK", korean_name: "마스크네트워크", english_name: "Mask Network" },
...
//   { market: "BTC-YGG", korean_name: "일드길드게임즈", english_name: "Yield Guild Games" },
//   { market: "BTC-GTC", korean_name: "깃코인", english_name: "Gitcoin" },
//   { market: "BTC-OCEAN", korean_name: "오션프로토콜", english_name: "Ocean Protocol" },
//   { market: "BTC-CTC", korean_name: "크레딧코인", english_name: "Creditcoin" },
//   { market: "BTC-LPT", korean_name: "라이브피어", english_name: "Livepeer" },
//   { market: "KRW-AVAX", korean_name: "아발란체", english_name: "Avalanche" },
//   { market: "BTC-AVAX", korean_name: "아발란체", english_name: "Avalanche" },
//   { market: "BTC-IMX", korean_name: "이뮤터블엑스", english_name: "Immutable X" },
//   { market: "BTC-RNDR", korean_name: "렌더토큰", english_name: "Render Token" },
...
//   { market: "BTC-RAD", korean_name: "래드웍스", english_name: "Radworks" },
//   { market: "BTC-AGLD", korean_name: "어드벤처골드", english_name: "Adventure Gold" },
//   { market: "BTC-API3", korean_name: "에이피아이쓰리", english_name: "API3" },
//   { market: "BTC-ARPA", korean_name: "알파", english_name: "ARPA" },
//   { market: "BTC-ENS", korean_name: "이더리움네임서비스", english_name: "Ethereum Name Service" },
...
//   { market: "BTC-ACM", korean_name: "AC밀란", english_name: "AC Milan Fan Token" },
//   { market: "BTC-AFC", korean_name: "아스날", english_name: "Arsenal Fan Token" },
//   {
//     market: "BTC-ATM",
//     korean_name: "아틀레티코마드리드",
//     english_name: "Atletico De Madrid Fan Token",
//   },
//   { market: "BTC-BAR", korean_name: "FC바르셀로나", english_name: "FC Barcelona Fan Token" },
//   { market: "BTC-CITY", korean_name: "맨체스터시티", english_name: "Manchester City Fan Token" },
//   { market: "BTC-INTER", korean_name: "인터밀란", english_name: "Inter Milan Fan Token" },
//   { market: "BTC-NAP", korean_name: "나폴리", english_name: "Napoli Fan Token" },
...
//   { market: "BTC-ACS", korean_name: "액세스프로토콜", english_name: "Access Protocol" },
...
//   { market: "BTC-EGLD", korean_name: "멀티버스엑스", english_name: "MultiversX" },
//   { market: "KRW-SUI", korean_name: "수이", english_name: "Sui" },
//   { market: "BTC-SUI", korean_name: "수이", english_name: "Sui" },
//   { market: "KRW-GRT", korean_name: "더그래프", english_name: "The Graph" },
//   { market: "KRW-BLUR", korean_name: "블러", english_name: "Blur" },
//   { market: "BTC-MINA", korean_name: "미나", english_name: "Mina" },
//   { market: "KRW-IMX", korean_name: "이뮤터블엑스", english_name: "Immutable X" },
//   { market: "BTC-STG", korean_name: "스타게이트파이낸스", english_name: "Stargate Finance" },
//   { market: "BTC-SEI", korean_name: "세이", english_name: "Sei" },
//   { market: "KRW-SEI", korean_name: "세이", english_name: "Sei" },
//   { market: "BTC-CYBER", korean_name: "사이버커넥트", english_name: "CyberConnect" },
//   { market: "BTC-GLMR", korean_name: "문빔", english_name: "Moonbeam" },
//   { market: "KRW-MINA", korean_name: "미나", english_name: "Mina" },
//   { market: "BTC-ID", korean_name: "스페이스아이디", english_name: "SPACE ID" },
//   { market: "BTC-AXL", korean_name: "엑셀라", english_name: "Axelar" },
//   { market: "KRW-CTC", korean_name: "크레딧코인", english_name: "Creditcoin" },
//   { market: "KRW-ASTR", korean_name: "아스타", english_name: "Astar" },
//   { market: "BTC-SPURS", korean_name: "토트넘홋스퍼", english_name: "Tottenham Hotspur" },
// ];

// const krwMarketNames = markets
//   .filter((m) => m.market.startsWith("KRW-"))
//   .reduce((acc, m) => {
//     const symbol = m.market.replace("KRW-", "");
//     acc[symbol] = m.korean_name;
//     return acc;
//   }, {});

// console.log(krwMarketNames);
const request = require("request");
const url = `https://api.upbit.com/v1/ticker?markets=KRW-LSK`;
